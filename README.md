...
Also, please check our [Reminders](dev/src/jofisaes/jeorg-spring-master-5-test-drives/reminders/Reminders.md) page, where short descriptions are presented in a flash card fashion for specific theoretical aspects of the Spring Framework.

We all know, in a way, what Spring Boot is, but sometimes it is very important to explain what it actually is. Find more in our [Technology](./Technology.md) section.
